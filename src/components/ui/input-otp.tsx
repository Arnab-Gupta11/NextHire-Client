  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex h-10 w-10 xsm:w-14 items-center justify-center border-y border-r border-input text-sm shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md border-secondary-bg-light dark:border-secondary-bg-dark text-slate-700 dark:text-slate-300 font-medium",
